...
test('retries preserve receipt, score, sequence and event count',function()
...
test('wrong answers do not consume a correct rank; tiers reach the floor',function()
...
test('answer receipt and live snapshot hide result until reveal',function()
...
test('retry of previous round cannot score or advance the new round',function()
...
test('deadline equality rejects even before the timer runs',function()
...
test('membership, host authority, revoked access and name uniqueness',function()
...
test('corrupt type fails before writes',function()
...
test('room expiry finalizes once; terminal snapshots reveal scores',function()
