...
| CI (GitHub Actions) | .github/workflows/ci.yml | PASS with cold caches: "verify gate" 170 s, "release images from verified artifacts" 44 s; caches saved (Gradle 239 MB, npm 40 MB). Before ADR 0007 the same jobs took 189 s and 131 s (run 35891087371 on 66e8443). Runs 35887767601 and 35888459355 ended in startup_failure before any job started because Actions was unavailable for the private repository; the owner fixed the account setting on 2026-09-23 | 5289032 | ubuntu-latest runner, Docker from the runner image, actions on Node 24 | 2026-09-23 | https://github.com/tungnguyenitvn/kahoot/actions/runs/35892588183 |
