...
| CI (GitHub Actions) | .github/workflows/ci.yml | PASS: jobs "verify gate" and "release images build and smoke" green, artifact verification-reports uploaded; the previous green run on 69aa258 is 35890521756. Runs 35887767601 and 35888459355 ended in startup_failure before any job started because Actions was unavailable for the private repository; the owner fixed the account setting on 2026-09-23 | 66e8443 | ubuntu-latest runner, Docker from the runner image, actions on Node 24 | 2026-09-23 | https://github.com/tungnguyenitvn/kahoot/actions/runs/35891087371 |
