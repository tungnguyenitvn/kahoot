...
| CI (GitHub Actions) | .github/workflows/ci.yml | PASS with warm caches: "verify gate" 118 s (Gradle build 35 s, npm install 7 s, both caches hit), "release images from verified artifacts" 47 s. Cold-cache run 35892588183 on 5289032: 170 s and 44 s, caches saved (Gradle 239 MB, npm 40 MB). Before ADR 0007 the same jobs took 189 s and 131 s (run 35891087371 on 66e8443). Runs 35887767601 and 35888459355 ended in startup_failure before any job started because Actions was unavailable for the private repository; the owner fixed the account setting on 2026-09-23 | 82dc8b0 | ubuntu-latest runner, Docker from the runner image, actions on Node 24 | 2026-09-24 | https://github.com/tungnguyenitvn/kahoot/actions/runs/35893152449 |
| Release (GitHub Actions) | .github/workflows/release.yml | NOT RUN: no v* tag pushed yet | none | none | none | none |
| Branch protection on main | GitHub repository settings | NOT ENFORCED: branch protection and rulesets are unavailable for a private repository on the free plan (API answered 403 "Upgrade to GitHub Pro or make this repository public"); the required checks in [delivery](../development/delivery.md) stay a convention until the repository is public or on GitHub Pro | none | github.com | 2026-09-24 | none |
