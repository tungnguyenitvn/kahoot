...
/** Runs room.lua with the eight same-room keys of the Redis room contract; the script is the room aggregate. */
@Component
public class LuaRooms implements RoomCommands {
    ...
    public LuaRooms(StringRedisTemplate redis, ObjectMapper json) {
