...
Run npm test, npm run test:ui AND npm run build; Node tests do not compile Angular
templates, component specs (*.spec.ts, Vitest + jsdom) render them without a browser.
